<nav class="col-2 border-end border-secondary d-flex flex-column text-white bg-dark position-fixed" style=" min-height: 100vh;">
    <div class="dropdown p-2 ">
      ...
      <ul class="nav nav-pills flex-column mb-auto p-2">
          ...
          <li class="nav-item" role="presentation">
              <a class="nav-link text-white" id="profile-tab" data-toggle="modal" data-target="#exampleModalCenter" data-bs-toggle="tab" data-bs-target="#profile" type="button" role="tab" aria-controls="profile" aria-selected="false" href="candidate/voting">
